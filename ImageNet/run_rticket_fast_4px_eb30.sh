...
PREFIX1=eb30_fast_adv_phase1_${NAME}
PREFIX2=eb30_fast_adv_phase2_${NAME}
PREFIX3=eb30_fast_adv_phase3_${NAME}

OUT1=eb30_fast_adv_phase1_${NAME}.out
OUT2=eb30_fast_adv_phase2_${NAME}.out
OUT3=eb30_fast_adv_phase3_${NAME}.out

EVAL1=eb30_fast_eval_phase1_${NAME}.out
EVAL2=eb30_fast_eval_phase2_${NAME}.out
EVAL3=eb30_fast_eval_phase3_${NAME}.out

END1=trained_models/eb30_fast_adv_phase1_${NAME}_step2_eps4_repeat1/checkpoint_epoch6.pth.tar
END2=trained_models/eb30_fast_adv_phase2_${NAME}_step2_eps4_repeat1/checkpoint_epoch12.pth.tar
END3=trained_models/eb30_fast_adv_phase3_${NAME}_step2_eps4_repeat1/checkpoint_epoch15.pth.tar

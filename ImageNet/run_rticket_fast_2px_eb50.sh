...
python -u main_fast_ticket.py $DATA160 -c $CONFIG1 --output_prefix $PREFIX1 --eb_path ResNet50/pruned_5008_0.5/pruned.pth.tar | tee $OUT1
...
python -u main_fast_ticket.py $DATA352 -c $CONFIG2 --output_prefix $PREFIX2 --eb_path ResNet50/pruned_5008_0.5/pruned.pth.tar  --resume $END1 | tee $OUT2
...
python -u main_fast_ticket.py $DATA -c $CONFIG3 --output_prefix $PREFIX3 --eb_path ResNet50/pruned_5008_0.5/pruned.pth.tar  --resume $END2 | tee $OUT3
